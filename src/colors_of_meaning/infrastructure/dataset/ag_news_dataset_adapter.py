...
class AGNewsDatasetAdapter(DatasetRepository):
    def __init__(self) -> None:
        self._label_names = ["World", "Sports", "Business", "Sci/Tech"]

    def get_samples(self, split: str, max_samples: Optional[int] = None) -> List[EvaluationSample]:
        dataset = load_dataset("fancyzhx/ag_news", split=split)  # nosec B615
